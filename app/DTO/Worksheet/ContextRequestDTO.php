...
final class ContextRequestDTO implements DTOContracts
{
    public function __construct(
        ...
        public string $risk_qualification_id,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            risk_qualification_id: $data['risk_qualification_id'] ?? $data['risk_qualification'] ?? '',
    ...
    public function toArray(): array
    {
        return [
            ...
            'risk_qualification_id' => $this->risk_qualification_id,
