        ...
        $data = $this->worksheets->map(function ($worksheet) use (&$currentIndex) {
            return $worksheet->incidents->map(function ($incident) use ($worksheet, &$currentIndex) {
                ...
                return [
                    ...
                    'Key Risk Indicators' => strip_html($incident->kri_body),
                    'Unit Satuan KRI' => $incident->kri_unit?->name,
                    'Aman' => strip_html($incident->kri_threshold_safe),
                    'Hati-Hati' => strip_html($incident->kri_threshold_caution),
                    'Bahaya' => strip_html($incident->kri_threshold_danger),
