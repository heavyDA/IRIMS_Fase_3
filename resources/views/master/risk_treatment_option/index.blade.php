...
@push('top-script')
    @vite(['resources/js/pages/master/risk_treatment_option/index.js'])
@endpush

@section('header-content')
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Opsi Perlakuan Risiko</h1>
        <div class="">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">Master</li>
                    <li class="breadcrumb-item active" aria-current="page">Opsi Perlakuan Risiko</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('main-content')
    <x-card>
        <x-slot name="body">
            ...
            <table id="risk-treatment-option-table" class="table table-bordered table-hover display nowrap"
                style="width: 100%;">
