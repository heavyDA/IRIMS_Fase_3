            ...
            <form method="POST" action="{{ route('master.bumn_scales.store') }}" class="row gap-2">
                ...
                <div class="col-12">
                    ...
                    <select name="impact_category"
                        ...
                        <option {{ old('impact_category') == 'kualitatif' ? 'selected' : null }} value="kualitatif">
                            Kualitatif</option>
                        <option {{ old('impact_category') == 'kuantitatf' ? 'selected' : null }} value="kuantitatf">
                            Kuantitatf</option>
                    </select>
                ...
                <div class="col-12">
                    ...
                    <input value="{{ old('scale') }}" name="scale" type="number" required
                ...
                <div class="col-12">
                    ...
                    <input value="{{ old('criteria') }}" name="criteria" type="text" required
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" cols="4"
                        class="form-control {{ $errors->has('description') ? 'is-invalid' : null }}">{{ old('description') }}</textarea>
                    @error('description')
                        <x-forms.error :message="$message"></x-forms.error>
                    @enderror
                </div>
                <div class="col-12 row p-0 m-0">
                    <div class="col-12 col-md-6">
                        ...
                        <input value="{{ old('min') }}" name="min" type="number" required
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input value="{{ old('max') }}" name="max" type="number" required
