...
@push('top-script')
    @vite(['resources/js/pages/master/existing_control_type/index.js'])
@endpush

@section('header-content')
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Jenis Existing Control</h1>
        <div class="">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item">Master</li>
                    <li class="breadcrumb-item active" aria-current="page">Jenis Existing Control</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('main-content')
    <x-card>
        <x-slot name="body">
            ...
            <table id="existing-control-type-table" class="table table-bordered table-hover display nowrap"
                style="width: 100%;">
