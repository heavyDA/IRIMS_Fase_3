...
@section('header-content')
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Form Tambah Kualifikasi Risiko</h1>
        <div class="">
            <nav>
...
@section('main-content')
    <x-card>
        <x-slot name="body">
            <form method="POST" action="{{ route('master.risk_qualifications.store') }}" class="row gap-2">
                @csrf
