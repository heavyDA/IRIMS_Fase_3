...
@section('header-content')
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Form Tambah Kategori Kejadian</h1>
        <div class="">
            <nav>
...
@section('main-content')
    <x-card>
        <x-slot name="body">
            <form method="POST" action="{{ route('master.incident_categories.store') }}" class="row gap-2">
                @csrf
