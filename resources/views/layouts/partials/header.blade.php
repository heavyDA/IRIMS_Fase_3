        ...
        <ul class="header-content-right">
            ...
            <li class="header-element dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-xl-2 me-0">
                            <img src="{{ asset('assets/images/media/user_blank.jpg') }}" alt="img" class="avatar avatar-sm avatar-rounded">
                        </div>
                        <div class="d-xl-block d-none lh-1">
                            <span class="fw-medium lh-1">Mr. {{ auth()->user()->first_name . ' ' . auth()->user()->last_name }}</span>
                        </div>
                    </div>
                </a>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                    ...
                    <li><a href="javascript:void(0);" onclick="document.querySelector('#signoutForm').submit()" class="dropdown-item d-flex align-items-center"><i
                                class="ti ti-logout me-2 fs-16"></i>Log out</a>
                    </li>
                </ul>
            </li>
            <!-- End::header-element -->
