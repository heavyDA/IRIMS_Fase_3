...
@section('main-content')
    <x-card>
        <x-slot name="body">
            <form id="alteration-form" method="POST" action="{{ route('risk.report.alterations.store') }}"
                class="row gap-2">
                @csrf
                <div class="row mb-1">
                    <div class="col-3">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col">
                        ...
                        <textarea name="body" class="form-control d-none {{ $errors->has('body') ? 'is-invalid' : null }}"></textarea>
                        @error('body')
                            <x-forms.error :message="$message"></x-forms.error>
                        @enderror
                    </div>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col">
                        ...
                        <textarea name="impact" class="form-control d-none {{ $errors->has('impact') ? 'is-invalid' : null }}"></textarea>
                        @error('impact')
                            <x-forms.error :message="$message"></x-forms.error>
                        @enderror
                    </div>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col">
                        ...
                        <textarea name="description" class="form-control d-none {{ $errors->has('description') ? 'is-invalid' : null }}"></textarea>
                        @error('description')
                            <x-forms.error :message="$message"></x-forms.error>
                        @enderror
                    </div>
