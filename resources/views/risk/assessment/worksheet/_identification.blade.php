<form id="identificationForm">
    <div class="row w-75 mx-auto">
        <div class="col">
            <div class="row mb-3">
                ...
                <div class="col">
                    <input value="{{ auth()->user()->company->organization_name }}" type="text"
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    <input value="{{ auth()->user()->company->organization_code }}" type="text"
                        class="form-control not-allowed" disabled>
                </div>
            </div>
            <div class="row mb-3">
    ...
    <button type="button" class="btn btn-secondary-light" data-bs-toggle="modal" data-bs-target="#identificationModal">
        <i class="ti ti-plus"></i>Tambah Peristiwa Risiko
    </button>

    <div class="row mt-2">
        <div class="col py-2" style="overflow-x: scroll;">
            <table id="worksheetIdentificationTable" class="table table-bordered table-stripped" style="width:100%">
        ...
        <div class="modal-dialog" style="max-width: 100% !important;">
            <div class="modal-content mx-auto" style="width: 80vw !important">
                ...
                <div class="modal-body">
                    <form id="identificationCauseForm">
                        <div id="identificationCauseFormAlert"
                            class="alert alert-danger alert-dismissible hide fade mb-2">
                            <p></p>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <select name="risk_cause_number" class="form-select" data-custom>
                                    <option>Pilih</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <ul class="nav nav-tabs mb-3 nav-justified tab-style-5 d-sm-flex d-block" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" data-bs-toggle="tab" role="tab"
                                    href="#identificationInherentTab" aria-selected="true">Inheren</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" role="tab"
                                    href="#identificationResidualTab" aria-selected="false" tabindex="-1">Residual</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane border-0 p-2 show active" id="identificationInherentTab">
                                <div class="row mb-3">
                                    <div data-kualitatif="Penjelasan Dampak Kualitatif"
                                        ...
                                        class="col label-category-risk">Dampak</div>
                                    <div class="col">
                                        <div class="mb-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-3">Nilai Probabilitas Inheren <span
                                            class="label-category-risk"></span></div>
                                    <div class="col">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                name="inherent_impact_probability">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-3">Skala Probabilitas Inheren <span
                                            class="label-category-risk"></span></div>
                                    <div class="col">
                                        <select data-placeholder="Pilih" disabled data-custom class="form-select"
                                ...
                                <div class="row mb-3">
                                    <div class="col-3">Eksposur Risiko <span
                ...
                <div class="modal-footer">
                    <button type="reset" form="identificationCauseForm" class="btn btn-secondary">Batal</button>
                    <button type="submit" form="identificationCauseForm" class="btn btn-primary">Simpan</button>
                </div>
            </div>
        </div>
    </div>
