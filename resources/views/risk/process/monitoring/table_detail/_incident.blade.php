        ...
        <table id="alterationTable" class="table table-stripped table-bordered w-100">
            <thead class="table-dark">
                <tr>
                    ...
                    <th>Kategori Risiko BUMN</th>
                    <th>Kategori Risiko T2 & T3BUMN</th>
            ...
            <tbody>
                @isset($monitoring)
                    <tr>
                        ...
                        <td>{{ $monitoring->incident?->risk_category?->name }}</td>
                        ...
                        <td>{{ $monitoring->incident->loss_value }}</td>
                        ...
                        <td>{{ $monitoring->incident->insurance_permit }}</td>
                        <td>{{ $monitoring->incident->insurance_claim }}</td>
                    </tr>
                @endisset
            </tbody>
        </table>
