    ...
    <div id="risk-chart" style="height: 500px; width:550px;">
        <svg width="100%" height="100%" viewBox="0 0 262 262">
            ...
            <g>
                ...
                <g>
                    <rect x="20" y="2" width="39" height="38" fill="white" stroke="black" stroke-width="0.5">
                    </rect>
                    <text x="30" y="19" font-family="arial" font-size="5" fill="black"
                        font-weight="bold">Hampir</text>
                    <text x="24" y="25" font-family="arial" font-size="5" fill="black" font-weight="bold">Pasti
                        Terjadi</text>
            ...
            <g>
                ...
                <g>
                    ...
                    <text x="80" y="220" font-family="arial" font-size="5" fill="black"
                        font-weight="bold">1</text>
                    <text x="64" y="229" font-family="arial" font-size="5" fill="black" font-weight="bold">Sangat
                        rendah</text>
                ...
                <g>
                    <rect x="102" y="202" width="38" height="39" fill="white" stroke="black"
                        stroke-width="0.5"></rect>
                ...
                <g>
                    <rect x="142" y="202" width="38" height="39" fill="white" stroke="black"
                        stroke-width="0.5"></rect>
                ...
                <g>
                    <rect x="182" y="202" width="38" height="39" fill="white" stroke="black"
                        stroke-width="0.5"></rect>
                ...
                <g>
                    <rect x="222" y="202" width="38" height="39" fill="white" stroke="black"
                        stroke-width="0.5"></rect>
