<div class="d-flex flex-column">
    <ul class="nav nav-tabs mb-3 nav-justified tab-style-6 d-flex" style="overflow-x: auto;" id="monitoringTab"
        ...
        <li class="not-allowed nav-item" role="presentation">
            <div class="d-flex flex-column gap-2 align-items-center justify-content-center">
                ...
                <a class="not-allowed active py-1" role="tab" href="#stepperActualization" aria-selected="false"
        ...
        <li class="nav-item not-allowed" role="presentation">
            <div class="d-flex flex-column gap-2 align-items-center justify-content-center">
                <h2 style="width: 72px !important; height: 72px;"
                    class="bg-light rounded-circle d-flex px-4 py-1 align-items-center justify-content-center">
                    2
                </h2>
                <a class="not-allowed py-1" role="tab" href="#stepperResidual" aria-selected="true" tabindex="-1">
    ...
    <div class="tab-content">
        <div class="tab-pane border-0 p-2 show active" id="stepperActualization" role="tabpanel">
            @include('risk.monitoring.form._actualization')
        </div>
        <div class="tab-pane border-0 p-2" id="stepperResidual" role="tabpanel">
